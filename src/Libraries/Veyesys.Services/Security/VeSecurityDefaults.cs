...
namespace Veyesys.Services.Security
{
    ...
    /// </summary>
    public static partial class VeSecurityDefaults
    {
        #region reCAPTCHA
        ...
        /// {0} : customer role ID
        /// </remarks>
        public static CacheKey PermissionRecordsAllCacheKey => new("Nop.permissionrecord.all.{0}", VeEntityCacheDefaults<PermissionRecord>.AllPrefix);
