...
namespace Veyesys.Services.Configuration
{
    ...
    public partial class SettingService : ISettingService
    {
        ...
        {
            return await _staticCacheManager.GetAsync(VeSettingsDefaults.SettingsAllAsDictionaryCacheKey, async () =>
            {
        ...
        {
            await _staticCacheManager.RemoveByPrefixAsync(VeEntityCacheDefaults<Setting>.Prefix);
        }
