...
namespace Veyesys.Services.Themes
{
    /// <summary>
    ...
    public partial class ThemeProvider : IThemeProvider
    {
        ...
        public ThemeProvider(IVeFileProvider fileProvider)
        {
        ...
        protected virtual void Initialize()
        {
            ...
            lock (_locker)
            {
                ...
                var themeDirectoryPath = _fileProvider.MapPath(VePluginDefaults.ThemesPath);
                foreach (var descriptionFile in _fileProvider.GetFiles(themeDirectoryPath,
                    VePluginDefaults.ThemeDescriptionFileName, false))
                {
