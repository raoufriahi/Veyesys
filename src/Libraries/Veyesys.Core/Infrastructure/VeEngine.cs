...
using Veyesys.Core.Infrastructure.Mapper;

namespace Veyesys.Core.Infrastructure
{
    /// <summary>
    /// Represents Veyesys engine
    /// </summary>
    public class VeEngine : IEngine
    {
        #region Utilities
        ...
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var typeFinder = Singleton<ITypeFinder>.Instance;
            var startupConfigurations = typeFinder.FindClassesOfType<IVeStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                .Select(startup => (IVeStartup)Activator.CreateInstance(startup))
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new VeException("Unknown dependency");
                        return service;
                    });
            ...
            throw new VeException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
