...
{
    /// <summary>
    /// A class that finds types needed by Veyesys by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Veyesys.
        /// </returns>
        ...
        /// <summary>Gets or sets whether Veyesys should iterate assemblies in the app domain when loading Veyesys types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Veyesys assemblies aren't investigated (e.g. by not including something like "^Veyesys|..." you may break core functionality.</remarks>
