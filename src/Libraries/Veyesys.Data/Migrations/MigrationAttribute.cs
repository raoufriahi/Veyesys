...
namespace Veyesys.Data.Migrations
{
    /// <summary>
    ...
    public partial class MigrationAttribute : FluentMigrator.MigrationAttribute
    {
        ...
        /// <param name="targetMigrationProcess">The target migration process</param>
        public MigrationAttribute(string dateTime, string nopVersion, UpdateMigrationType migrationType, MigrationProcessType targetMigrationProcess = MigrationProcessType.NoMatter) :
