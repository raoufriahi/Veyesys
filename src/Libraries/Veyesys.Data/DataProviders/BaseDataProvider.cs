...
namespace Veyesys.Data.DataProviders
{
    public abstract class BaseDataProvider : IMappingEntityAccessor
    {
        ...
        protected static ConcurrentDictionary<Type, Veyesys.Data.Mapping.EntityDescriptor> EntityDescriptors { get; } = new ConcurrentDictionary<Type, Veyesys.Data.Mapping.EntityDescriptor>();
        ...
        public virtual Veyesys.Data.Mapping.EntityDescriptor GetEntityDescriptor(Type entityType)
        {
            return EntityDescriptors.GetOrAdd(entityType, t =>
            {
                ...
                return new Veyesys.Data.Mapping.EntityDescriptor
                {
