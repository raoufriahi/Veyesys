...
namespace Veyesys.Web.Framework.Validators
{
    ...
    public abstract class BaseNopValidator<TModel> : AbstractValidator<TModel> where TModel : class
    {
        ...
        protected virtual void SetStringPropertiesMaxLength(VeEntityDescriptor entityDescriptor, params string[] filterPropertyNames)
        {
        ...
        /// </summary>
        /// <param name="entityDescriptor">Entity descriptor</param>
        protected virtual void SetDecimalMaxValue(VeEntityDescriptor entityDescriptor)
        {
            if (entityDescriptor is null)
                return;
