...
namespace Veyesys.Web.Framework.Security
{
    /// <summary>
    ...
    public static class FilePermissionHelper
    {
        ...
        public static IEnumerable<string> GetFilesWrite(this INopFileProvider fileProvider)
        {
            ...
            {
                fileProvider.MapPath(VePluginDefaults.PluginsInfoFilePath),
                fileProvider.MapPath(VeDataSettingsDefaults.FilePath),
                fileProvider.MapPath(VeConfigurationDefaults.AppSettingsFilePath)
            };
        }
