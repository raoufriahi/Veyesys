...
using Veyesys.Web.Framework.Models;
//using Veyesys.Web.Framework.Mvc.Filters;
using Veyesys.Web.Framework.UI;

namespace Veyesys.Web.Framework.Controllers
{
    /// <summary>
    /// Base controller
    /// </summary>
    ...
    public abstract class BaseController : Controller
    {
        ...
        {
            var nopHtmlHelper = EngineContext.Current.Resolve<IVeHtmlHelper>();
        ...
        public virtual void SaveSelectedCardName(string cardName, bool persistForTheNextRequest = true)
        {
            ...
            //"GetSelectedCardName" method of \Veyesys.Web.Framework\Extensions\HtmlExtensions.cs
        ...
        {
            //keep this method synchronized with
            //"GetSelectedTabName" method of \Veyesys.Web.Framework\Extensions\HtmlExtensions.cs
