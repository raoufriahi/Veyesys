...
namespace Veyesys.Web.Framework.UI
{
    /// <summary>
    /// Represents the HTML helper implementation
    /// </summary>
    public partial class VeHtmlHelper : IVeHtmlHelper
    {
        #region Fields
        ...
        public VeHtmlHelper(AppSettings appSettings,
        ...
        public virtual string GetRouteName(bool handleDefaultRoutes = false)
        {
            ...
            if (httpContext.GetRouteValue(VePathRouteDefaults.SeNameFieldKey) is not null &&
                httpContext.GetRouteValue(VePathRouteDefaults.ActionFieldKey) is string actionKey)
            {
