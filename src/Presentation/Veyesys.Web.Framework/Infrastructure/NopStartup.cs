...
//using Veyesys.Services.Authentication.MultiFactor;
//using Veyesys.Services.Blogs;
//using Veyesys.Services.Catalog;
//using Veyesys.Services.Cms;
using Veyesys.Services.Common;
//using Veyesys.Services.Configuration;
//using Veyesys.Services.Customers;
//using Veyesys.Services.Directory;
//using Veyesys.Services.Discounts;

//using Veyesys.Services.ExportImport;
//using Veyesys.Services.Forums;
...
//using Veyesys.Services.Messages;
//using Veyesys.Services.News;
//using Veyesys.Services.Orders;
//using Veyesys.Services.Payments;
...
namespace Veyesys.Web.Framework.Infrastructure
{
    ...
    public class NopStartup : INopStartup
    {
        ...
        {
            //file provider
            services.AddScoped<INopFileProvider, FileProvider>();
            ...
            foreach (var setting in settings)
            {
                services.AddScoped(setting, serviceProvider =>
                {
                    ...
                    return 0; // serviceProvider.GetRequiredService<ISettingService>().LoadSettingAsync(setting, storeId).Result;
                });
            }
