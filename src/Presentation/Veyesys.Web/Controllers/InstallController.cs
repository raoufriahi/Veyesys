...
using Veyesys.Web.Framework.Security;
using Veyesys.Web.Infrastructure.Installation;
using Veyesys.Web.Models.Install;
    ...
    public partial class InstallController : Controller
    {
        ...
        public virtual async Task<IActionResult> Index(InstallModel model)
        {
            ...
            try
            {
                ...
                var cultureInfo = new CultureInfo(VeCommonDefaults.DefaultLanguageCulture);
                var regionInfo = new RegionInfo(VeCommonDefaults.DefaultLanguageCulture);
                ...
                if (model.InstallRegionalResources)
                {
                    ...
                    if (cultureInfo.Name != VeCommonDefaults.DefaultLanguageCulture)
                    {
                        try
                        {
